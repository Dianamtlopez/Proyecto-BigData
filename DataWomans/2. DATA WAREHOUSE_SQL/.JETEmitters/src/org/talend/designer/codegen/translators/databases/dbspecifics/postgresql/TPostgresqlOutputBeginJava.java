...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_54 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        } else if (updateKeyCount_";
  protected final String TEXT_55 = " == ";
  protected final String TEXT_56 = " && ";
  protected final String TEXT_57 = ") {";
  protected final String TEXT_58 = "        " + NL + "                throw new RuntimeException(\"";
  protected final String TEXT_59 = "\");";
  protected final String TEXT_60 = NL + "                    log.warn(\"";
  protected final String TEXT_61 = NL + "                    System.err.println(\"";
  ...
  protected final String TEXT_71 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_72 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_73 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_74 = "=0;" + NL + "int rowsToCommitCount_";
  ...
  protected final String TEXT_83 = NL + "\t\tjava.sql.Savepoint  sp_";
  protected final String TEXT_84 = " = null;" + NL + "\t";
  protected final String TEXT_85 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_86 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_87 = ") {" + NL + "\t\t\tString dsAlias_";
  ...
  protected final String TEXT_94 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    ";
  ...
  protected final String TEXT_116 = NL + "    \tjava.sql.Savepoint  sp_";
  protected final String TEXT_117 = NL + "        conn_";
  protected final String TEXT_118 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_122 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\");" + NL + "    }";
  protected final String TEXT_123 = NL + "   int batchSize_";
  protected final String TEXT_124 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_125 = "=0;";
  protected final String TEXT_126 = NL + "int count_";
  ...
  protected final String TEXT_138 = ".commit();";
  protected final String TEXT_139 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_140 = NL + "                              stmtCreate_";
  protected final String TEXT_141 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_142 = "));";
  protected final String TEXT_143 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_144 = ";" + NL + "\t                    if (";
  protected final String TEXT_145 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_146 = " = 0; x_";
  protected final String TEXT_147 = " < dynamic_";
  protected final String TEXT_148 = ".getColumnCount(); x_";
  protected final String TEXT_149 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_150 = " = dynamic_";
  protected final String TEXT_151 = ".getColumnMetadata(x_";
  protected final String TEXT_152 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_153 = ".setName(column_";
  protected final String TEXT_154 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_155 = ".execute(((\"";
  protected final String TEXT_156 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_164 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_165 = ";" + NL + "                    if (";
  protected final String TEXT_166 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_167 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_168 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_169 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_170 = NL;
  protected final String TEXT_171 = NL + "                    String keyCheckTable_";
  protected final String TEXT_172 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_173 = "+\"][\"+";
  protected final String TEXT_174 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_175 = " + \"]\";";
  protected final String TEXT_176 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  ...
  protected final String TEXT_182 = NL + "                                boolean whetherExist_";
  protected final String TEXT_183 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_184 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_185 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_186 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_187 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_188 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                        whetherExist_";
  protected final String TEXT_189 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_196 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_197 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_201 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_202 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_203 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_204 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_217 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_223 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_224 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_225 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_226 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_227 = " = stmtSchema_";
  protected final String TEXT_228 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_229 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_230 = " = rsSchema_";
  protected final String TEXT_231 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_232 = ".toLowerCase()";
  ...
  protected final String TEXT_236 = "(schema_";
  ...
  protected final String TEXT_250 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  ...
  protected final String TEXT_258 = ".getMetaData();";
  protected final String TEXT_259 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_260 = ".getTables(";
  protected final String TEXT_261 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_262 = ".getTables(conn_";
  protected final String TEXT_263 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_264 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_269 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_276 = ") {" + NL + "\t\t\t\t\t\t                        for (int x_";
  protected final String TEXT_277 = "++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_278 = ");" + NL + "\t\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_279 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_283 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_284 = NL + "                                                      stmtDrop_";
  protected final String TEXT_285 = NL + "                                        stmtDrop_";
  protected final String TEXT_286 = NL + "                                    }";
  protected final String TEXT_287 = NL + "                                            conn_";
  protected final String TEXT_288 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_289 = NL + "                                                  stmtCreate_";
  protected final String TEXT_290 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_291 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_292 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_293 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_294 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_295 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  ...
  protected final String TEXT_300 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_305 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_306 = NL + "                              stmtTruncCount_";
  protected final String TEXT_307 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_308 = " = stmtTruncCount_";
  protected final String TEXT_309 = ".executeQuery(\"";
  protected final String TEXT_310 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_311 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_312 = " = rsTruncCount_";
  protected final String TEXT_313 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_314 = NL + "                              stmtTrunc_";
  protected final String TEXT_315 = NL + "                conn_";
  protected final String TEXT_316 = NL + "                stmtTrunc_";
  protected final String TEXT_317 = NL + "                    if(!conn_";
  protected final String TEXT_318 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_319 = ".commit();" + NL + "                    }";
  protected final String TEXT_320 = NL + "                deletedCount_";
  protected final String TEXT_321 = " += rsTruncCountNumber_";
  protected final String TEXT_322 = ";" + NL + "            }";
  protected final String TEXT_323 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_324 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_329 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_340 = " = null;" + NL + "\t\t\tString keyPsmt_";
  ...
  protected final String TEXT_352 = ".prepareStatement(update_";
  protected final String TEXT_353 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_354 = " + \"\\\" WHERE ";
  protected final String TEXT_355 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_356 = ");" + NL + "\t    String insert_";
  protected final String TEXT_357 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_358 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_359 = "\", pstmtInsert_";
  protected final String TEXT_360 = ");" + NL + "\t    String update_";
  protected final String TEXT_361 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_362 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_363 = "\", pstmtUpdate_";
  protected final String TEXT_364 = NL + "\t    String delete_";
  protected final String TEXT_365 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_366 = ".prepareStatement(delete_";
  protected final String TEXT_367 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_376 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_377 = NL + "\t\t\tdelete_";
  protected final String TEXT_378 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_379 = " = delete_";
  ...
  protected final String TEXT_383 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_384 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_385 = " = insertIgnore_";
  protected final String TEXT_386 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_387 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_388 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_389 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_390 = " = true;" + NL + "    \t";
  protected final String TEXT_391 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_392 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_393 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_394 = " =null;" + NL + "\t";
  protected final String TEXT_395 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_396 = " = null;" + NL + "\t\t";
  protected final String TEXT_397 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_398 = " =  null;";
  protected final String TEXT_399 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_400 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_401 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_402 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_403 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
