...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_60 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_61 = " = 0; x_";
  protected final String TEXT_62 = " < dynamic_";
  protected final String TEXT_63 = ".getColumnCount(); x_";
  protected final String TEXT_64 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_65 = " = dynamic_";
  protected final String TEXT_66 = ".getColumnMetadata(x_";
  protected final String TEXT_67 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_68 = ".setName(column_";
  protected final String TEXT_69 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_70 = ".execute(((\"";
  protected final String TEXT_71 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_79 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_80 = ";" + NL + "                    if (";
  protected final String TEXT_81 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_82 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_83 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_84 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_85 = NL;
  protected final String TEXT_86 = NL + "                    String keyCheckTable_";
  protected final String TEXT_87 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_88 = "+\"][\"+";
  protected final String TEXT_89 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_90 = " + \"]\";";
  protected final String TEXT_91 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_92 = " + \"[checktable]\" + \"[\" + ";
  ...
  protected final String TEXT_97 = NL + "                                boolean whetherExist_";
  protected final String TEXT_98 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_99 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_100 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_101 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_102 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_103 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                        whetherExist_";
  protected final String TEXT_104 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_105 = NL + "                                ";
  protected final String TEXT_106 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_107 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_108 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_109 = " = tableNameForSearch_";
  protected final String TEXT_110 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_111 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_112 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_113 = " = dbMetaData_";
  protected final String TEXT_114 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_115 = ", tableNameForSearch_";
  protected final String TEXT_116 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_117 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_118 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_119 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_123 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  ...
  protected final String TEXT_132 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_142 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_148 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_149 = ".toLowerCase()";
  protected final String TEXT_150 = ") || ((dbschema_";
  protected final String TEXT_151 = " ==null || dbschema_";
  protected final String TEXT_152 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_153 = "(schema_";
  protected final String TEXT_154 = NL + "                                String tableForSearch_";
  protected final String TEXT_155 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_156 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_157 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_158 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_159 = " =  tableForSearch_";
  protected final String TEXT_160 = ".substring(1,tableForSearch_";
  protected final String TEXT_161 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_162 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_163 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_164 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_165 = ".getTables(null, conn_";
  protected final String TEXT_166 = ".getSchema(), tableForSearch_";
  protected final String TEXT_167 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_168 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_169 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_170 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_171 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_172 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_173 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_174 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_175 = ".getMetaData();";
  protected final String TEXT_176 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_177 = ".getTables(";
  protected final String TEXT_178 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_179 = ".getTables(conn_";
  protected final String TEXT_180 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  ...
  protected final String TEXT_186 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_187 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_188 = NL + "                                if(!whetherExist_";
  protected final String TEXT_189 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_200 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_201 = NL + "                                                      stmtDrop_";
  protected final String TEXT_202 = NL + "                                        stmtDrop_";
  protected final String TEXT_203 = NL + "                                    }";
  protected final String TEXT_204 = NL + "                                            conn_";
  protected final String TEXT_205 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_206 = NL + "                                                  stmtCreate_";
  protected final String TEXT_207 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_208 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_209 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_210 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_211 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_212 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_213 = NL + "                                    stmtCreate_";
  protected final String TEXT_214 = NL + "                                }";
  protected final String TEXT_215 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_216 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_217 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_218 = NL + "                              stmtClear_";
  protected final String TEXT_219 = NL + "                stmtClear_";
  protected final String TEXT_220 = ".executeUpdate(\"";
  protected final String TEXT_221 = "\");";
  protected final String TEXT_222 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_223 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_224 = NL + "                              stmtTruncCount_";
  protected final String TEXT_225 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_226 = " = stmtTruncCount_";
  protected final String TEXT_227 = ".executeQuery(\"";
  protected final String TEXT_228 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_229 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_230 = " = rsTruncCount_";
  protected final String TEXT_231 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_232 = NL + "                              stmtTrunc_";
  protected final String TEXT_233 = NL + "                conn_";
  protected final String TEXT_234 = NL + "                stmtTrunc_";
  protected final String TEXT_235 = NL + "                    if(!conn_";
  protected final String TEXT_236 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_237 = ".commit();" + NL + "                    }";
  protected final String TEXT_238 = NL + "                deletedCount_";
  protected final String TEXT_239 = " += rsTruncCountNumber_";
  protected final String TEXT_240 = ";" + NL + "            }";
  protected final String TEXT_241 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_242 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_243 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_247 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_248 = NL + "\t\t\troutines.system.Dynamic dynamic_";
  protected final String TEXT_249 = ";" + NL + "            if (";
  protected final String TEXT_250 = ") {" + NL + "                for (int x_";
  protected final String TEXT_251 = "++) {" + NL + "                \troutines.system.DynamicMetadata column_";
  protected final String TEXT_252 = ");" + NL + "                \tcolumn_";
  protected final String TEXT_253 = ".getName().toLowerCase());" + NL + "                }" + NL + "            }";
  protected final String TEXT_254 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_255 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_256 = " + \"\\\" (";
  protected final String TEXT_257 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(dynamic_";
  protected final String TEXT_258 = "\")+\") VALUES (";
  protected final String TEXT_259 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(dynamic_";
  protected final String TEXT_260 = ")+\")\";";
  protected final String TEXT_261 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(dynamic_";
  protected final String TEXT_262 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(dynamic_";
  protected final String TEXT_263 = NL + "    pstmt_";
  protected final String TEXT_264 = ".prepareStatement(insert_";
  protected final String TEXT_265 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_266 = "\", pstmt_";
  protected final String TEXT_267 = " = null;" + NL + "    String keyPsmt_";
  ...
  protected final String TEXT_271 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_272 = ");" + NL + "        GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_273 = ", pstmt_";
  protected final String TEXT_274 = ");" + NL + "    }else{" + NL + "        pstmt_";
  protected final String TEXT_275 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_276 = ");" + NL + "    }";
  protected final String TEXT_277 = NL + "\t\t\t\tString update_";
  protected final String TEXT_278 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_279 = " + \"\\\" SET ";
  protected final String TEXT_280 = ", \"+DynamicUtils.getUpdateSet(dynamic_";
  protected final String TEXT_281 = "\")+\" WHERE ";
  protected final String TEXT_282 = "\";";
  protected final String TEXT_283 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(dynamic_";
  protected final String TEXT_284 = NL + "\t    pstmt_";
  protected final String TEXT_285 = ".prepareStatement(update_";
  protected final String TEXT_286 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_287 = ");" + NL + "\t    ";
  protected final String TEXT_288 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_289 = " + \"\\\" WHERE ";
  protected final String TEXT_290 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_291 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_292 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_293 = "\", pstmtInsert_";
  protected final String TEXT_294 = ");" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_295 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_296 = "\", pstmtUpdate_";
  protected final String TEXT_297 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_298 = NL + "\t    String delete_";
  protected final String TEXT_299 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_300 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_301 = ".prepareStatement(delete_";
  protected final String TEXT_302 = NL + "       \t";
  protected final String TEXT_303 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_304 = " = insert_";
  protected final String TEXT_305 = ".split(\"\\\\?\");";
  protected final String TEXT_306 = NL + "\t\t\tupdate_";
  protected final String TEXT_307 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_308 = " = update_";
  protected final String TEXT_309 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_310 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_311 = NL + "\t\t\tdelete_";
  protected final String TEXT_312 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_313 = " = delete_";
  protected final String TEXT_314 = NL + "\t\t\treplace_";
  protected final String TEXT_315 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_316 = " = replace_";
  protected final String TEXT_317 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_318 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_319 = " = insertIgnore_";
  protected final String TEXT_320 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_321 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_322 = " = buffersSize_";
  protected final String TEXT_323 = ";";
  protected final String TEXT_324 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_325 = NL + "        whetherReject_";
  protected final String TEXT_326 = " = false;";
  protected final String TEXT_327 = NL + "                        query_";
  protected final String TEXT_328 = NL + "                            geometryColumnName_";
  protected final String TEXT_329 = " = \"";
  protected final String TEXT_330 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_331 = ") {" + NL + "                                dimension_";
  protected final String TEXT_332 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_333 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_334 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_335 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_336 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_337 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_338 = " = refSys_";
  protected final String TEXT_339 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_340 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_341 = " == null || ident_";
  protected final String TEXT_342 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_343 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_344 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_345 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_346 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_347 = " = Integer.parseInt(code_";
  protected final String TEXT_348 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_349 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                            String SRIDError_";
  protected final String TEXT_350 = " = \"SRID_";
  protected final String TEXT_351 = " could not be determined\";";
  protected final String TEXT_352 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_353 = ");" + NL + "                                            SRID_";
  protected final String TEXT_354 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_355 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_356 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_357 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_358 = ",";
  protected final String TEXT_359 = ", ";
  protected final String TEXT_360 = ",insertSQLSplits_";
  protected final String TEXT_361 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_362 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_363 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_364 = NL + "                globalMap.put(\"";
  protected final String TEXT_365 = "_QUERY\", query_";
  protected final String TEXT_366 = ".toString().trim());";
  protected final String TEXT_367 = NL + "\t\t\t";
  protected final String TEXT_368 = NL + "    \t\tpstmt_";
  protected final String TEXT_369 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_370 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_371 = NL + "    \t\t  ";
  protected final String TEXT_372 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_373 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_374 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_375 = NL + "                \tsp_";
  protected final String TEXT_376 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_377 = NL + "                int processedCount_";
  protected final String TEXT_378 = " = pstmt_";
  protected final String TEXT_379 = ".executeUpdate();" + NL + "                insertedCount_";
  protected final String TEXT_380 = " += processedCount_";
  protected final String TEXT_381 = ";" + NL + "                rowsToCommitCount_";
  protected final String TEXT_382 = NL + "\t\t\t\t";
  protected final String TEXT_383 = NL + "\t                conn_";
  protected final String TEXT_384 = ".releaseSavepoint(sp_";
  protected final String TEXT_385 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_386 = NL + "            } catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_387 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_388 = ".rollback(sp_";
  protected final String TEXT_389 = ");" + NL + "\t            ";
  protected final String TEXT_390 = NL + "                whetherReject_";
  protected final String TEXT_391 = " = true;";
  protected final String TEXT_392 = NL + "                    throw(e);";
  protected final String TEXT_393 = " = new ";
  protected final String TEXT_394 = "Struct();";
  protected final String TEXT_395 = NL + "                        rejectedCount_";
  protected final String TEXT_396 = " = rejectedCount_";
  protected final String TEXT_397 = " + 1;";
  protected final String TEXT_398 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_399 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_400 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_401 = NL + "            }";
  protected final String TEXT_402 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_403 = ",updateSQLSplits_";
  protected final String TEXT_404 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_405 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_412 = NL + "\t                sp_";
  protected final String TEXT_413 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_414 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_415 = NL + "                \tconn_";
  protected final String TEXT_416 = NL + "                    \t";
  protected final String TEXT_417 = NL + "            int checkCount_";
  protected final String TEXT_418 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_419 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_420 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_421 = " = rs_";
  protected final String TEXT_422 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_426 = ", pstmtUpdate_";
  protected final String TEXT_427 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t\t\t\tquery_";
  protected final String TEXT_429 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_430 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_431 = NL + "                    globalMap.put(\"";
  protected final String TEXT_432 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t                    sp_";
  protected final String TEXT_434 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_435 = NL + "                    int processedCount_";
  protected final String TEXT_436 = " = pstmtUpdate_";
  protected final String TEXT_437 = ".executeUpdate();" + NL + "                    updatedCount_";
  protected final String TEXT_438 = ";" + NL + "                    rowsToCommitCount_";
  ...
  protected final String TEXT_443 = NL + "                } catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_444 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_445 = NL + "                    whetherReject_";
  protected final String TEXT_446 = NL + "                        throw(e);";
  protected final String TEXT_447 = NL + "                        nb_line_";
  protected final String TEXT_448 = NL + "                                ";
  protected final String TEXT_449 = NL + "                            rejectedCount_";
  protected final String TEXT_450 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_451 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_452 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_453 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_455 = ", pstmtInsert_";
  protected final String TEXT_456 = " = pstmtInsert_";
  protected final String TEXT_457 = ".executeUpdate();" + NL + "                    insertedCount_";
  protected final String TEXT_458 = NL + "                }" + NL + "            }";
  protected final String TEXT_459 = NL + "            int updateFlag_";
  protected final String TEXT_460 = "=0;";
  protected final String TEXT_461 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_462 = NL + "    \t\t\t\t\t";
  protected final String TEXT_463 = NL + "\t\t\t\t\t\tquery_";
  protected final String TEXT_464 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_465 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_466 = NL + "                updateFlag_";
  protected final String TEXT_467 = "=pstmtUpdate_";
  protected final String TEXT_468 = " = updatedCount_";
  protected final String TEXT_469 = "+updateFlag_";
  protected final String TEXT_470 = " += updateFlag_";
  protected final String TEXT_471 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_472 = NL + "            if(updateFlag_";
  protected final String TEXT_473 = " == 0) {" + NL + "            \t";
  protected final String TEXT_474 = NL + "\t\t\t\tquery_";
  protected final String TEXT_475 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_476 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_477 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_478 = "++;" + NL + "    \t\t\t\t\t";
  protected final String TEXT_479 = NL + "     \t\t\t\t\t";
  protected final String TEXT_480 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_481 = NL + "                }";
  protected final String TEXT_482 = NL + "\t                        query_";
  protected final String TEXT_483 = ";" + NL + "\t                        ";
  protected final String TEXT_484 = ".addBatch();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_485 = "++;" + NL + "\t\t\t  ";
  protected final String TEXT_486 = "++;" + NL + "    \t\t";
  protected final String TEXT_487 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_488 = ".executeUpdate();" + NL + "                deletedCount_";
  protected final String TEXT_489 = ";" + NL + "                nb_line_";
  protected final String TEXT_490 = NL + "                    nb_line_";
  protected final String TEXT_491 = NL + "            if(!whetherReject_";
  protected final String TEXT_492 = ") {";
  protected final String TEXT_493 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_494 = " > 0) && (batchSize_";
  protected final String TEXT_495 = " <= batchSizeCounter_";
  protected final String TEXT_496 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_497 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_498 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_499 = ": pstmt_";
  protected final String TEXT_500 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_501 = " += (countEach_";
  protected final String TEXT_502 = " < 0 ? 0 : countEach_";
  protected final String TEXT_503 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_504 = NL + "\t\t\t\t    \trowsToCommitCount_";
  protected final String TEXT_505 = " += countSum_";
  ...
  protected final String TEXT_510 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_511 = "){" + NL + "globalMap.put(\"";
  protected final String TEXT_512 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_513 = ".getMessage());" + NL + "\t\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_514 = " = e_";
  protected final String TEXT_515 = ".getNextException(),sqle_";
  protected final String TEXT_516 = "=null;" + NL + "\t\t\t\t    \tString errormessage_";
  protected final String TEXT_517 = ";" + NL + "\t\t\t\t\t\tif (ne_";
  protected final String TEXT_518 = " != null) {" + NL + "\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_519 = " = new java.sql.SQLException(e_";
  protected final String TEXT_520 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_521 = ".getMessage(), ne_";
  protected final String TEXT_522 = ".getSQLState(), ne_";
  protected final String TEXT_523 = ".getErrorCode(), ne_";
  protected final String TEXT_524 = ");" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_525 = " = sqle_";
  protected final String TEXT_526 = ".getMessage();" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_527 = ".getMessage();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t    \t";
  protected final String TEXT_528 = NL + "\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_529 = " != null) {" + NL + "\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_530 = ");" + NL + "\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t            \tthrow(e_";
  protected final String TEXT_531 = ");" + NL + "\t\t\t\t            }" + NL + "\t\t\t\t    \t";
  protected final String TEXT_532 = NL + "\t\t\t\t    \tint countSum_";
  protected final String TEXT_533 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_534 = ": e_";
  protected final String TEXT_535 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_536 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\trowsToCommitCount_";
  protected final String TEXT_537 = NL + "\t\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_538 = ");" + NL + "\t\t\t\t    \t";
  protected final String TEXT_539 = NL + "\t\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_540 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_541 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_542 = " <= commitCounter_";
  protected final String TEXT_543 = NL + "                if ((batchSize_";
  protected final String TEXT_544 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_545 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  ...
  protected final String TEXT_549 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_550 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_551 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_552 = NL + "                batchSizeCounter_";
  protected final String TEXT_553 = " = 0;" + NL + "               }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_554 = ".getMessage());" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_555 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_556 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_557 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_558 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_559 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_560 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t";
  protected final String TEXT_561 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_562 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_563 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_564 = ");" + NL + "\t\t\t            }" + NL + "\t\t\t    \t";
  protected final String TEXT_565 = NL + "\t\t\t    \tint countSum_";
  protected final String TEXT_566 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_567 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_568 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trowsToCommitCount_";
  protected final String TEXT_569 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_570 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_571 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_572 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_573 = NL + "\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_574 = ");" + NL + "\t\t\t    \t";
  protected final String TEXT_575 = NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_576 = NL + "                    if(rowsToCommitCount_";
  protected final String TEXT_577 = " != 0){" + NL + "                    \t";
  protected final String TEXT_578 = NL + "                    }" + NL + "                    conn_";
  protected final String TEXT_579 = ".commit();" + NL + "                    if(rowsToCommitCount_";
  protected final String TEXT_580 = NL + "                    \trowsToCommitCount_";
  protected final String TEXT_581 = " = 0;" + NL + "                    }" + NL + "                    commitCounter_";
