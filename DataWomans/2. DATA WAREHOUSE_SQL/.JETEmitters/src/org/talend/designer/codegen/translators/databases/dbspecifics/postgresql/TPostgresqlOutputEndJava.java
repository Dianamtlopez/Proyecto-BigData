...
public class TPostgresqlOutputEndJava
{
  ...
  protected final String TEXT_83 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trowsToCommitCount_";
  ...
  protected final String TEXT_90 = NL + "\t\t    \t    deletedCount_";
  protected final String TEXT_91 = NL + "\t    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_92 = "){" + NL + "globalMap.put(\"";
  protected final String TEXT_93 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_94 = ".getMessage());" + NL + "\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_95 = " = e_";
  protected final String TEXT_96 = ".getNextException(),sqle_";
  protected final String TEXT_97 = "=null;" + NL + "\t    \tString errormessage_";
  protected final String TEXT_98 = ";" + NL + "\t\t\tif (ne_";
  protected final String TEXT_99 = " != null) {" + NL + "\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\tsqle_";
  protected final String TEXT_100 = " = new java.sql.SQLException(e_";
  protected final String TEXT_101 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_102 = ".getMessage(), ne_";
  protected final String TEXT_103 = ".getSQLState(), ne_";
  protected final String TEXT_104 = ".getErrorCode(), ne_";
  protected final String TEXT_105 = ");" + NL + "\t\t\t\terrormessage_";
  protected final String TEXT_106 = " = sqle_";
  protected final String TEXT_107 = ".getMessage();" + NL + "\t\t\t}else{" + NL + "\t\t\t\terrormessage_";
  protected final String TEXT_108 = ".getMessage();" + NL + "\t\t\t}" + NL + "\t    \t";
  protected final String TEXT_109 = NL + "\t    \t\tif (ne_";
  protected final String TEXT_110 = " != null) {" + NL + "\t    \t\t\tthrow(sqle_";
  protected final String TEXT_111 = ");" + NL + "\t    \t\t}else{" + NL + "\t            \tthrow(e_";
  protected final String TEXT_112 = ");" + NL + "\t            }" + NL + "\t    \t";
  protected final String TEXT_113 = NL + "\t    \tint countSum_";
  protected final String TEXT_114 = " = 0;" + NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_115 = ": e_";
  protected final String TEXT_116 = ".getUpdateCounts()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_117 = ");" + NL + "\t\t\t}" + NL + "\t\t\trowsToCommitCount_";
  protected final String TEXT_118 = ";" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_120 = ";" + NL + "\t    \t";
  protected final String TEXT_121 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_122 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_123 = NL + "\t    \tSystem.err.println(errormessage_";
  ...
  protected final String TEXT_134 = NL + "\t\t\tif(rowsToCommitCount_";
  protected final String TEXT_135 = " != 0){" + NL + "\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t}" + NL + "\t\t\tconn_";
  protected final String TEXT_137 = ".commit();" + NL + "\t\t\tif(rowsToCommitCount_";
  protected final String TEXT_138 = NL + "\t\t\t\trowsToCommitCount_";
  protected final String TEXT_139 = " = 0;" + NL + "\t\t\t}" + NL + "\t\t\tcommitCounter_";
  ...
  protected final String TEXT_145 = NL + "\tnb_line_deleted_";
  protected final String TEXT_146 = "=nb_line_deleted_";
  protected final String TEXT_147 = "+ deletedCount_";
  protected final String TEXT_148 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_149 = "=nb_line_update_";
  protected final String TEXT_150 = " + updatedCount_";
  protected final String TEXT_151 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_152 = "=nb_line_inserted_";
  protected final String TEXT_153 = " + insertedCount_";
  protected final String TEXT_154 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_155 = "=nb_line_rejected_";
  protected final String TEXT_156 = " + rejectedCount_";
  protected final String TEXT_157 = ";" + NL + "\t";
  protected final String TEXT_158 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_159 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_160 = "_NB_LINE\",nb_line_";
  protected final String TEXT_161 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_162 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_163 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_164 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_165 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_175 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_176 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_177 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_178 = "_NB_LINE_REJECTED\",nb_line_rejected_";
