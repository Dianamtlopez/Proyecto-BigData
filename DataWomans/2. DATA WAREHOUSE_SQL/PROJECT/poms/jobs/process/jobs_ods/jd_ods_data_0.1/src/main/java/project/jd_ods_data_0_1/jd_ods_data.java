...
package project.jd_ods_data_0_1;
...
public class jd_ods_data implements TalendJob {
	...
	public static class carga_ods_airbnbStruct implements routines.system.IPersistableRow<carga_ods_airbnbStruct> {
		final static byte[] commonByteArrayLock_PROJECT_jd_ods_data = new byte[0];
		static byte[] commonByteArray_PROJECT_jd_ods_data = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_jd_ods_data.length) {
					if (length < 1024 && commonByteArray_PROJECT_jd_ods_data.length == 0) {
						commonByteArray_PROJECT_jd_ods_data = new byte[1024];
					} else {
						commonByteArray_PROJECT_jd_ods_data = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_jd_ods_data, 0, length);
				strReturn = new String(commonByteArray_PROJECT_jd_ods_data, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJECT_jd_ods_data, 0, length);
				strReturn = new String(commonByteArray_PROJECT_jd_ods_data, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_jd_ods_data) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XxVImenqrQtYca4BfS6nSwCYUIr/DJFwXCfQ+rT1GZl9yVGX");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:rFAsMVWdNYGIUY4svDZpM2SYu+WA80xKd9GjmRUZghn0EJHo");
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jd_ods_data.class.getClassLoader()
					.getResourceAsStream("project/jd_ods_data_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 156059 characters generated by Talend Open Studio for Data Integration on the
 * 15 de febrero de 2023, 15:25:17 CET
 ************************************************************************************************/